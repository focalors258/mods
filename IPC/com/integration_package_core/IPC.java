...
import com.integration_package_core.animation.AnimationSync;
import com.integration_package_core.util.RegistryHandler.*;
...
//属性注册
  //  public static final DeferredRegister<Attribute> ATTRIBUTE= DeferredRegister.create(ForgeRegistries.ATTRIBUTES, MODID);
    ...
    public IPC(FMLJavaModLoadingContext context)
    {
...
//实体注册
        ...
        BlockEntityRegistry.BLOCKENTITY.register(modEventBus);
      ...
      //  modEventBus.post(new KeyBindsEvent())
        ...
        context.registerConfig(ModConfig.Type.COMMON, Config.BUILDER.build());
    }
    ...
    private void commonSetup(final FMLCommonSetupEvent event)
    {
        ...
        if (Config.log_dirt_block)
            LOGGER.info("DIRT BLOCK >> {}", ForgeRegistries.BLOCKS.getKey(Blocks.DIRT));

        LOGGER.info(Config.magic_number_introduction + Config.magic_number);
...
//        });
    ...
    public static class ClientModEvents
    {
        ...
        {//;//将menu和screen绑定 必须在此注册
            ...
            //动画同步
            //renderEvent.o();
            AnimationSync.client();

           // AnimationSync.server();
