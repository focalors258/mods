...
//   Vec3 vec31 = MathUtils.getWorldPosFromModel(animatable, animatable.yBodyRot, (GeoBone) swordLocate1);
    ...
    public ResourceLocation getModelResource(PlayerAnimationEntity entity) {
        ...
        if (entity.model != null) {
            return entity.model;//bug  无法加载从服务端获得的模型地址
        }
        return new ResourceLocation(IPC.MODID, "geo/animation_entity/main.geo.json");
    ...
    public ResourceLocation getTextureResource(PlayerAnimationEntity entity) {
        ...
        } else if (entity.player instanceof LocalPlayer p) {
        ...
        return new ResourceLocation(IPC.MODID, "textures/entity/tartaric_acid.png");
    ...
    public ResourceLocation getAnimationResource(PlayerAnimationEntity entity) {
        ...
        if (entity.animationResource!=null&& !Objects.equals(entity.getAnimation(), "air"))return entity.animationResource;

        return new ResourceLocation(IPC.MODID, "animations/animation_entity/main.animation.json");
    }
}
