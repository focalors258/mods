...
import com.chestsearch.gui.ItemContainer;
...
public class CustomizeMenu extends AbstractContainerMenu {
  ...
  public CustomizeMenu(int pContainerId) {
    ...
    public CustomizeMenu(int pContainerId, Container pLectern, ContainerData pLecternData) {
        ...
        super(newMenu.Customize.get(), pContainerId);
