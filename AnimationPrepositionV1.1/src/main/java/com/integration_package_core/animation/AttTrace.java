...
public class AttTrace {
    ...
    public static void render(ArrayList<Matrix4f> TraceList, MultiBufferSource bufferSource, PoseStack poseStack, PlayerAnimationEntity entity, float r1, float r2) {
