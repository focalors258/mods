...
//属性注册
    ...
    public ChestSearch(FMLJavaModLoadingContext context)
    {
        ...
        //菜单注册添加进事件线
       newMenu.MENUS.register(modEventBus);

        newNetwork.registerPackets();
...
//        });
    ...
    public static class ClientModEvents
    {
        ...
        public static void onClientSetup(FMLClientSetupEvent event)
        {
            ...
            event.enqueueWork(newMenu::connect);//<---------将menu和screen绑定
